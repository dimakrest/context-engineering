...
**Check your project's testing documentation** for the complete list of test commands and requirements.
...
- API contract changes -> E2E tests
...
- [ ] Run ALL relevant tests (must pass)
