...
- Is it avoiding over-engineering?
...
- **Architect**: [1 sentence - Does this fit the system well?]
...
|---|------|--------------|-------------|
| 1 | Completeness | / / | [One-liner] |
| 2 | Technical Feasibility | / / | [One-liner] |
| 3 | Risk Assessment | / / | [One-liner] |
| 4 | Testing Strategy | / / | [One-liner] |
| 5 | Implementation Order | / / | [One-liner] |
| 6 | YAGNI Compliance | / / | [One-liner] |
...
| [Requirement 2] | Partial | [What's missing] |
...
- **Architect**: [System-level implications]
...
3. **Use Project Context**:
   - Apply YAGNI principles from project's CLAUDE.md
   - Follow testing standards from project documentation
