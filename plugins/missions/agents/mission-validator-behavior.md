...
tools:
  ...
  - Bash
  - ToolSearch
  - mcp__bell_test__start_call
  - mcp__bell_test__say
  - mcp__bell_test__send
  - mcp__bell_test__wait_response
  - mcp__bell_test__play_audio
  - mcp__bell_test__play_audio_async
  - mcp__bell_test__end_call
  - mcp__bell_test__list_calls
...
Your tool list names a project-specific conversational test server (`mcp__bell_test__*`). It is
