...
|---|---|---|---|---|---|---|
| A001 | Omitting the window equals the whole day | structural | F001 | unproven | — | min: named test; max: 1 pinning feature |
| A002 | Tenant A never sees tenant B | structural | F001, F002, F003 | unproven | — | min: mutation (tenancy); max: 1 pinning feature |
